       ...
       def __init__(self, root):
              ...
              def Insert():
                     if(len(self.referenceno.get()) != 0):
                            School_Library_Backend.insert(self.Mbtype.get(), self.referenceno.get(), self.firstname.get(), self.lastname.get() \
              ...
              def Display():
                     self.List_bx_2.delete(0, END)
                     for row in School_Library_Backend.view():
              ...
              def Delete():
                     School_Library_Backend.delete(selected_tuple[0])
                     Reset()
                     Display()
              ...
              def Search():
                     self.List_bx_2.delete(0, END)
                     for row in School_Library_Backend.search(self.Mbtype.get(), self.referenceno.get(), self.firstname.get(), self.lastname.get()\
                                                  , self.address.get(), self.post.get(), self.mobileno.get(), self.ID.get()\
                                                  , self.title.get(), self.author.get(), self.borrow.get(), self.due.get()\
                                                  , self.loan.get()):
                            self.List_bx_2.insert(END, row, str(' '))
