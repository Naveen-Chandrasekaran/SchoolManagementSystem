...
import random
import School_Std_info_BackEnd
              ...
              def information():
                     ...
                     def Add():
                            if(len(self.name.get()) != 0):
                               School_Std_info_BackEnd.insert(self.name.get(), self.father_name.get(), self.mother_name.get(), self.address.get(), self.mobileno.get(), self.email_address.get(), self.date_of_birth.get(), \
                                                               self.gender.get())
                     ...
                     def Display():
                               self.listbox.delete(0, END)
                               for row in School_Std_info_BackEnd.view():
                     ...
                     def Delete():
                            if(len(self.name.get()) != 0):
                               School_Std_info_BackEnd.delete(selected_tuple[0])
                               Reset()
                               Display()
                     ...
                     def Search():
                            self.listbox.delete(0, END)
                            for row in School_Std_info_BackEnd.search(self.name.get(), self.father_name.get(), self.mother_name.get(), self.address.get(), self.mobileno.get(), self.email_address.get(), self.date_of_birth.get(), self.gender.get()):
                                   self.listbox.insert(END, row, str(' '))
