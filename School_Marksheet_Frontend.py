from tkinter import *  
import random
import School_Marksheet_Backend
...
def marking_sheet():
       ...
       def Add():
              if (len(roll.get()) != 0):
                     School_Marksheet_Backend.insert(name.get(), roll.get(), father_name.get(), mother_name.get(), date_of_birth.get(), gender.get(), \
                                                      school.get(), email_address.get(), marks1.get(), marks2.get(), marks3.get(), marks4.get(), marks5.get(), marks6.get() , \
                                                      grand_tot.get(), percentage.get(), cgpa.get(), grade.get(), division.get(), result.get())

       def Update():
              if (len(roll.get()) != 0):
                     School_Marksheet_Backend.update(name.get(), roll.get(), father_name.get(), mother_name.get(), date_of_birth.get(), gender.get(), \
                                                      school.get(), email_address.get(), marks1.get(), marks2.get(), marks3.get(), marks4.get(), marks5.get(), marks6.get(), \
                                                      grand_tot.get(), percentage.get(), cgpa.get(), grade.get(), division.get(), result.get())
       ...
       def Compute():
              num1 = (marks1.get());      num2 = (marks2.get());    num3 = (marks3.get());      num4 = (marks4.get());    num5 = (marks5.get()); num6 = (marks6.get());
              ...
              Percentage = ((num1 + num2 + num3 + num4 + num5+ num6) * 100) / 600
              percentage.set(Percentage)


              c_grades = (((num1+num2+num3+num4+num5+num6) * 100)/600) / 9.5
              ...
              if (((num1+num2+num3+num4+num5+num6) * 100)/600) <= 35:
                     grades = 'E'
              elif (((num1+num2+num3+num4+num5+num6) * 100)/600) <= 50:
                     grades = 'D'
              elif (((num1+num2+num3+num4+num5+num6) * 100)/600) <= 75:
                     grades = 'C'
              elif (((num1+num2+num3+num4+num5+num6) * 100)/600) <= 90:
                     grades = 'B'
              else:
                     grades = 'A'
              ...
              if (count == 0):
                     ...
                     result.set('PARTIAL PASS')
              else:
                     result.set('FAIL')

              if Percentage <= 35 and result != "FAIL":
                     division.set('THIRD')
       ...
       PROGRAMMING_lbl4 = Label(Marks_Frame_2, text = 'COMPUTER SCIENCE', font = ('arial',14), bg = 'Navajo white')
       ...
       TAMIL_lbl6 = Label(Marks_Frame_2, text = 'TAMIL', font = ('arial',14), bg = 'Navajo white')
       TAMIL_lbl6.grid(row = 9, column = 0)

       GRAND_TOTAL_lbl7 = Label(Marks_Frame_2, text = 'GRAND TOTAL', font = ('arial',16), bg = 'Navajo white')
       GRAND_TOTAL_lbl7.grid(row = 10, column = 0)
       PERCENTAGE_lbl8 = Label(Marks_Frame_2, text = 'PERCENTAGE', font = ('arial',16,'bold'), bg = 'Navajo white')
       PERCENTAGE_lbl8.grid(row = 11, column = 0)
       CGPA_lbl9 = Label(Marks_Frame_2, text = 'CGPA', font = ('arial',16,'bold'), bg = 'Navajo white')
       CGPA_lbl9.grid(row = 11, column = 2)
       GRADE_lbl10 = Label(Marks_Frame_2, text = 'GRADE', font = ('arial',16,'bold'), bg = 'Navajo white')
       GRADE_lbl10.grid(row = 11, column = 4)
       DIVISION_lbl11 = Label(Marks_Frame_2, text = 'DIVISION', font = ('arial',16,'bold'), bg = 'Navajo white')
       DIVISION_lbl11.grid(row = 12, column = 0)
       DIVISION_lbl11 = Label(Marks_Frame_2, text = 'RESULT', font = ('arial',16,'bold'), bg = 'Navajo white')
       DIVISION_lbl11.grid(row = 12, column = 2)
       

       variables_1 = StringVar(Marks_Frame_2, value = '35')
       variables_2 = StringVar(Marks_Frame_2, value = '100')
       variables_3 = StringVar(Marks_Frame_2, value = '600')
       ...
       Text_Entry6 = Entry(Marks_Frame_2, font = ('arial',16), width = 5, textvariable = marks6)
       Text_Entry6.grid(row = 9, column = 1)

       Text_Entry7 = Entry(Marks_Frame_2, font = ('arial',14), width = 5, textvariable = grand_tot, state = 'readonly')
       Text_Entry7.grid(row = 10, column = 1, pady = 8)
       Text_Entry8 = Entry(Marks_Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = percentage, state = 'readonly')
       Text_Entry8.grid(row = 11, column = 1, pady = 8)
       Text_Entry9 = Entry(Marks_Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = cgpa, state = 'readonly')
       Text_Entry9.grid(row = 11, column = 3, pady = 8)
       Text_Entry10 = Entry(Marks_Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = grade, state = 'readonly')
       Text_Entry10.grid(row = 11, column = 5, padx = 20, pady = 8)
       Text_Entry11 = Entry(Marks_Frame_2, font = ('arial',14,'bold'), width = 8, textvariable = division, state = 'readonly')
       Text_Entry11.grid(row = 12, column = 1, padx = 20, pady = 8)
       Text_Entry12 = Entry(Marks_Frame_2, font = ('arial',14,'bold'), width = 15, textvariable = result, state = 'readonly')
       Text_Entry12.grid(row = 12, column = 3, padx = 20, pady = 8)
       ...
       Text_Entry_6_2 = Entry(Marks_Frame_2, textvariable = variables_1, font = ('arial',16), width = 5, state = 'readonly')
       Text_Entry_6_2.grid(row = 9, column = 2, pady = 5)
       Text_Entry_6_3 = Entry(Marks_Frame_2, textvariable = variables_2, font = ('arial',16), width = 5, state = 'readonly')
       Text_Entry_6_3.grid(row = 9, column = 3)
       Text_Entry_7_3 = Entry(Marks_Frame_2, textvariable = variables_3, font = ('arial',16), width = 5, state = 'readonly')
       Text_Entry_7_3.grid(row = 10, column = 3)
...
def search_result_marksheet(row):
       ...
       marks6 = DoubleVar(Frame_2,row[0][14])
       grand_tot = DoubleVar(Frame_2,row[0][15])
       percentage = DoubleVar(Frame_2,row[0][16])
       cgpa = DoubleVar(Frame_2,row[0][17])
       grade = StringVar(Frame_2,row[0][18])
       div = StringVar(Frame_2,row[0][19])
       result = StringVar(Frame_2,row[0][20])
       ...
       CHEMISTRY_lbl3.grid(row = 6, column = 0)
       PROGRAMMING_lbl4 = Label(Frame_2, text = 'COMPUTER SCIENCE', font = ('arial',14), bg = 'Navajo white')
       PROGRAMMING_lbl4.grid(row = 7, column = 0)
       ENGLISH_lbl5 = Label(Frame_2, text = 'ENGLISH', font = ('arial',14), bg = 'Navajo white')
       ENGLISH_lbl5.grid(row = 8, column = 0)
       TAMIL_lbl6 = Label(Frame_2, text = 'TAMIL', font = ('arial',14), bg = 'Navajo white')
       TAMIL_lbl6.grid(row = 9, column = 0)

       GRAND_TOTAL_lbl7 = Label(Frame_2, text = 'GRAND TOTAL', font = ('arial',16), bg = 'Navajo white')
       GRAND_TOTAL_lbl7.grid(row = 10, column = 0)
       PERCENTAGE_lbl8 = Label(Frame_2, text = 'PERCENTAGE', font = ('arial',16,'bold'), bg = 'Navajo white')
       PERCENTAGE_lbl8.grid(row = 11, column = 0)
       CGPA_lbl9 = Label(Frame_2, text = 'CGPA', font = ('arial',16,'bold'), bg = 'Navajo white')
       CGPA_lbl9.grid(row = 11, column = 2)
       GRADE_lbbl10= Label(Frame_2, text = 'GRADE', font = ('arial',16,'bold'), bg = 'Navajo white')
       GRADE_lbbl10.grid(row = 11, column = 4)
       DIVISIONRESULT_lbl11 = Label(Frame_2, text = 'DIVISION', font = ('arial',16,'bold'), bg = 'Navajo white')
       DIVISIONRESULT_lbl11.grid(row = 12, column = 0)
       DIVISIONRESULT_lbl11= Label(Frame_2, text = 'RESULT', font = ('arial',16,'bold'), bg = 'Navajo white')
       DIVISIONRESULT_lbl11.grid(row = 12, column = 2)
       

       variables_1 = StringVar(Frame_2, value = '35')
       variables_2 = StringVar(Frame_2, value = '100')
       variables_3 = StringVar(Frame_2, value = '600')
       ...
       Text_Entry5.grid(row = 8, column = 1)
       Text_Entry6 = Entry(Frame_2, font = ('arial',16), width = 5, textvariable = marks6)
       Text_Entry6.grid(row = 9, column = 1)
       
       Text_Entry7= Entry(Frame_2, font = ('arial',14), width = 5, textvariable = grand_tot)
       Text_Entry7.grid(row = 10, column = 1, pady = 8)
       Text_Entry8 = Entry(Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = percentage)
       Text_Entry8.grid(row = 11, column = 1, pady = 8)
       Text_Entry9 = Entry(Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = cgpa)
       Text_Entry9.grid(row = 11, column = 3, pady = 8)
       Text_Entry10 = Entry(Frame_2, font = ('arial',14,'bold'), width = 5, textvariable = grade)
       Text_Entry10.grid(row = 11, column = 5, padx = 20, pady = 8)
       Text_Entry11 = Entry(Frame_2, font = ('arial',14,'bold'), width = 8, textvariable = div)
       Text_Entry11.grid(row = 12, column = 1, padx = 20, pady = 8)
       Text_Entry12 = Entry(Frame_2, font = ('arial',14,'bold'), width = 7, textvariable = result)
       Text_Entry12.grid(row = 12, column = 3, padx = 20, pady = 8)
       ...
       Text_Entry_5_3.grid(row = 8, column = 3)
       Text_Entry_6_2 = Entry(Frame_2, textvariable = variables_1, font = ('arial',16), width = 5)
       Text_Entry_6_2.grid(row = 9, column = 2, pady = 5)
       Text_Entry_6_3 = Entry(Frame_2, textvariable = variables_2, font = ('arial',16), width = 5)
       Text_Entry_6_3.grid(row = 9, column = 3)
       Text_Entry_7_3 = Entry(Frame_2, textvariable = variables_3, font = ('arial',16), width = 5)
       Text_Entry_7_3.grid(row = 10, column = 3)
