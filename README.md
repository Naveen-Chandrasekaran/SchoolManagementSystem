...
School management system is an integrated console based application that handles various academic activities of a School. It is a mini python project that is used to keep and maintain the complete record of Students. It was developed using Python Tkinter and used sqlite3.
...
```
git clone https://github.com/Naveen-Chandrasekaran/SchoolManagementSystem.git
```
